...
def dumpParametersToJSON(outdir) {
    ...
    // Pipeline configuration may contain helper closures, which JSON cannot serialise.
    def jsonParams = params.findAll { key, value -> !(value instanceof groovy.lang.Closure) }
    def jsonStr    = groovy.json.JsonOutput.toJson(jsonParams)
